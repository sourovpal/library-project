      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item {{ Route::is('admin.index') ? 'active' : '' }}">
...
<div class="d-flex flex-column-fluid" id="container-wrapper">
    <div class="container">
        <!--Begin::Row-->
        <div class="row">
            <div class="col-xl-3">
                ...
                <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
                    ...
                    <div class="card-body">
                        ...
                        <span class="font-weight-bold text-muted font-size-sm">Total Books</span>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 29-->
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-danger card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <span class="font-weight-bold text-white font-size-sm">Total Distribute</span>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 31-->
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-dark card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <span class="font-weight-bold text-white font-size-sm">Total Book Transaction</span>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 32-->
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header h-auto border-0">
                        ...
                        <div class="card-title py-5">
                            <h3 class="card-label">
                                <span class="d-block text-dark font-weight-bolder">Recent Products</span>
                                <span class="d-block text-muted mt-2 font-size-sm">More than 400+ new products</span>
                            </h3>
                        </div>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
