        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item active">
              <a href="{{ route('admin.web_pages.edit', $web->id) }}" class="text-muted">Edit Page</a>
            </li>
          </ul>
          <!--end::Breadcrumb-->
        </div>
...
<form class="form" action="{{route('admin.web_pages.update', $web->id)}}" method="POST" enctype="multipart/form-data">
@method('PUT')
  @csrf
...
<div class="card">
 <div class="card-body">
  <div class="form-group row">
   <div class="col-lg-6">
    <label>Title:</label>
    <input type="text" name="title" class="form-control" placeholder="Enter Title" value="{{$web->title}}"/>
  ...
  <div class="form-group row">
   <div class="col-lg-10">
    ...
    <div class="">
    <textarea name="description" class="form-control tinymce-editor">{{$web->description}}</textarea>
    </div>
  ...
  <div class="form-group row">
   <div class="col-lg-6">
    ...
    <div class="image-input image-input-outline" id="kt_image_1">
        <div class="image-input-wrapper" style="background-image: url({{asset($web->image)}})"></div>
