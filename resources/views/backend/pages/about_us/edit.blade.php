        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item active">
              <a href="{{ route('admin.libraries.edit_about_us', $about->id) }}" class="text-muted">Edit About</a>
            </li>
          </ul>
          <!--end::Breadcrumb-->
        </div>
...
<form class="form" action="{{route('admin.libraries.update_about_us', $about->id)}}" method="POST" enctype="multipart/form-data">
@csrf
 ...
 <div class="card-body">
  ...
  <div class="form-group row">
   <div class="col-lg-10">
    ...
    <div class="">
    <textarea name="description" rows="5" class="form-control tinymce-editor">{{$about->description}}</textarea>
    </div>
  ...
  <div class="form-group row">
   <div class="col-lg-6">
    ...
    <div class="image-input image-input-outline" id="kt_image_1">
        <div class="image-input-wrapper" style="background-image: url('{{url($about->image)}}')"></div>
