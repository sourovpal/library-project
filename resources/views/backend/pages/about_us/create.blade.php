        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item active">
              <a href="{{ route('admin.libraries.create_about_us') }}" class="text-muted">Create About</a>
            </li>
          </ul>
          <!--end::Breadcrumb-->
        </div>
...
<form class="form" action="{{route('admin.libraries.store_about_us')}}" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="card">
 <div class="card-body">
  <div class="form-group row">
   <div class="col-lg-6">
    <label>Title:</label>
    <input type="text" name="title" class="form-control" placeholder="Enter Title" value="About Us"/>
  ...
  <div class="form-group row">
   <div class="col-lg-6">
    ...
    <textarea name="description" rows="5" class="form-control tinymce-editor"></textarea>
    </div>
