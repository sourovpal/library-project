      ...
      <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent font-weight-bold p-0 my-2 font-size-sm">
          <li class="breadcrumb-item active">
            <a href="{{ route('admin.books.index') }}" class="text-muted">Manage Books</a>
          </li>
        </ul>
        <!--end::Breadcrumb-->
      </div>
  ...
  <div class="container-fluid" id="container-wrapper">
      <div class="card">
          <div class="card-body">
            ...
            <h4 class="header-title float-left">Manage About</h4>
            <p class="float-right mb-2">
                <a class="btn btn-primary font-weight-bold btn-square" href="{{ route('admin.books.create') }}">Create New Books</a>
            </p>
              <table class="table">
